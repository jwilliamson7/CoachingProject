...
\begin{table}[htbp]
\centering
\caption{Defensive Bias by Coach Background}
...
\begin{table}[htbp]
\centering
\caption{Top 10 Most Predictive Features}
...
\caption{Defensive-to-offensive importance ratio by era. The defensive bias is consistent across all eras (Kruskal-Wallis $p = 0.401$).}
\label{fig:shap_era}
\end{figure}
